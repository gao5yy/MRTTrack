...
class TBSITrack(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        network = build_select_track(params.cfg, training=False)
    ...
    def track(self, image, frame_path_v, frame_path_i, info: dict = None):
        ...
        with torch.no_grad():
            ...
            out_dict = self.network.forward(
                template=[self.z_dict1.tensors[:,:3,:,:],self.z_dict1.tensors[:,3:,:,:]], search=[x_dict.tensors[:,:3,:,:], x_dict.tensors[:,3:,:,:]], template_mask_zv=None,template_mask_zi=None)
