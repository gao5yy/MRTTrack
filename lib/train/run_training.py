...
def main():
    ...
    parser.add_argument('--script', type=str, default='select_track',  help='Name of the train script.')
    parser.add_argument('--config', type=str, default='vitb_256_select_32x1_1e4_lasher_15ep_sot',  help="Name of the config file.")  ####
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default='./output/vitb_256_select_32x1_1e4_lasher_15ep_sot' ,help='the directory to save checkpoints and logs') ######
